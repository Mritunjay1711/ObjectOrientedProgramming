...
class disMeter{
    ...
    public:
        ...
        disMeter addDistance(disFeet, disMeter);
};

class disFeet{
    int feet_26;
    int inches_26;
    friend disMeter disMeter :: addDistance(disFeet, disMeter);
    public:
        void setData(int a, int b)
        {
            feet_26 = a;
...
disMeter  disMeter :: addDistance(disFeet o1, disMeter o2)
{
    disMeter temp;
...
int main(){
    ...
    o1_26.setData(19, 11);
    o2_26.setData(50, 40);
    sum_26 = sum_26.addDistance(o1_26, o2_26);
    sum_26.display();
    return 0;
}